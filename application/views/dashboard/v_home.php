...
<div class="row g-4 mb-5">
    ...
    <!-- Card 1.7 -->
    <div class="col-xl-3 col-md-6">
        <a href="<?php echo site_url('indicator/iku_1_7'); ?>" class="indicator-menu-card">
            <div class="card-body">
                <div class="indicator-header">
    ...
    <!-- Card 1.8 -->
    <div class="col-xl-3 col-md-6">
        <a href="<?php echo site_url('indicator/iku_1_8'); ?>" class="indicator-menu-card">
            <div class="card-body">
                <div class="indicator-header">
    ...
    <!-- Card 1.9 -->
    <div class="col-xl-3 col-md-6">
        <a href="<?php echo site_url('indicator/iku_1_9'); ?>" class="indicator-menu-card">
            <div class="card-body">
                <div class="indicator-header">
